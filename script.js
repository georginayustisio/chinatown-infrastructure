...
function createSpaces(numberOfSpaces) {
  ...
  var gifToShow = document.querySelector(`#gifAnimation[src="gif/${buttonId}.gif"]`);
  if (gifToShow) {
  ...
  switch(buttonId) {
    case 'm9':
      ...
      rectangleText.innerHTML = 'Average Monthly Bus Ridership (2021)' + createSpaces(5)+ '-' + createSpaces(5) + '31,227';
      rectangleText.style.color = '#FFFFFF';
      break;
    case 'm14a':
      rectangle.style.backgroundColor = '#448B80'; 
      rectangleText.innerHTML = 'Average Monthly Bus Ridership (2021)' + createSpaces(5)+ '-' + createSpaces(5) + '57,301';
      rectangleText.style.color = '#FFFFFF';
      break;
    case 'm15':
      rectangle.style.backgroundColor = '#0A69AE'; 
      rectangleText.innerHTML = 'Average Monthly Bus Ridership (2021)' + createSpaces(5)+ '-' + createSpaces(5) + '83,710';
      rectangleText.style.color = '#FFFFFF';
      break;
    case 'm15s':
      rectangle.style.backgroundColor = '#0b73be'; 
      rectangleText.innerHTML = 'Average Monthly Bus Ridership (2021)' + createSpaces(5)+ '-' + createSpaces(5) + '151,436';
      rectangleText.style.color = '#FFFFFF';
      break;
    case 'm22':
      rectangle.style.backgroundColor = '#1CC2D8'; 
      rectangleText.innerHTML = 'Average Monthly Bus Ridership (2021)' + createSpaces(5)+ '-' + createSpaces(5) + '11,135';
      rectangleText.style.color = '#FFFFFF';
      break;
    case 'm55':
      rectangle.style.backgroundColor = '#8EC3A4'; 
      rectangleText.innerHTML = 'Average Monthly Bus Ridership (2021)' + createSpaces(5)+ '-' + createSpaces(5) + '8,143';
      rectangleText.style.color = '#FFFFFF';
      break;
    case 'm103':
      rectangle.style.backgroundColor = '#4F2A5F'; 
      rectangleText.innerHTML = 'Average Monthly Bus Ridership (2021)' + createSpaces(5)+ '-' + createSpaces(5) + '49,945';
      rectangleText.style.color = '#FFFFFF';
      break;
    case 'all':
      rectangle.style.backgroundColor = '#FFFFFF'; 
      rectangleText.innerHTML = 'Total Average Monthly Bus Ridership (2021)' + createSpaces(5)+ '-' + createSpaces(5) + ' 392,897';
